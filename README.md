...
[![Foo](www/images/browsers.png)](https://harshvideocall.herokuapp.com/)

## https://harshvideocall.herokuapp.com/

<br>

[![mirotalk](www/images/preview.png)](https://harshvideocall.herokuapp.com/)
...
-   `Open` https://harshvideocall.herokuapp.com/newcall `or` https://mirotalk.up.railway.app/newcall
...
-   You can also `join` directly to your `room` by going to https://harshvideocall.herokuapp.com/join/your-room-name-goes-here `or` https://mirotalk.up.railway.app/join/your-room-name-goes-here
...
curl -X POST "https://harshvideocall.herokuapp.com/api/v1/meeting" -H "authorization: mirotalk_default_secret" -H "Content-Type: application/json"
```

## API Documentation

The API documentation uses [swagger](https://swagger.io/) at http://localhost:3000/api/v1/docs. Or check it out on [railway](https://mirotalk.up.railway.app/api/v1/docs) & [heroku](https://harshvideocall.herokuapp.com/api/v1/docs).
...
`demo` https://harshvideocall.herokuapp.com/

[![heroku-qr](www/images/mirotalk-heroku-qr.png)](https://harshvideocall.herokuapp.com/)
